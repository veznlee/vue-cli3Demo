<template>
  <div class="fh-full-scroll">
            ...
            <div class="table-page-wrap f-pr">
              <div class="search-line clearfix">
                <div class="search-inline-item">
                  ...
                  <Input v-model="searchform.searchKey" size="large" class="commom-input" placeholder="部门名称"/>
                </div>
    ...
    <Modal
      ...
      title="部门">
      <depart-form v-if="hackReset" ref="editForm" @submit="submitEdit" :is-view="isView" :form-data="formData"></depart-form>
...
import departForm from './depart-form.vue'
  ...
  methods:{
    ...
    add(){
      ...
      this.formData = {
        ...
        pidText:this.openTree.title || '顶级部门'
      };
